...
//    private var edit_jam: EditText?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG,"3")
        val dialogLayout = inflater_alert.inflate(R.layout.alertdialog_apf, null)
        Log.d(TAG,"4")
        ...
        dialog.setOnShowListener {
            Log.d(TAG,"5")
            //=======================================Date===============================================
            val loc_spinner = findViewById<Spinner>(R.id.pilih_lok)
//            val edit_tanggal = findViewById<EditText>(R.id.edit_tgl)
//            val edit_jam = findViewById<EditText>(R.id.edit_jam)
